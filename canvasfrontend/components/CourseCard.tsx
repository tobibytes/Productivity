...
const CourseCard = ({
  ...
  return (
    <div className="h-full bg-white rounded-xl shadow p-5 hover:shadow-lg transition border border-gray-200 flex flex-col justify-between" onClick={() => router.push(`/courses/${course_id}?email=${email}`)}>
      <div>
